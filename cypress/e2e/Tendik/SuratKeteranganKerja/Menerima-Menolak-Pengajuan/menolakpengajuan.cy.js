...
describe("Menolak Pengajuan Surat Keterangan Kerja - Tendik Kepegawaian", () => {
  beforeEach(() => {
    loginTendik("ade.setiawan@staff.itera.ac.id", "setiawan19");
  });

  it("Harus berhasil menolak pengajuan surat keterangan kerja", () => {
