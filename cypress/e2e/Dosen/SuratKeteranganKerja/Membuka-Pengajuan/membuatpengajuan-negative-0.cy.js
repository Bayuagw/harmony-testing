...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (Keperluan Kosong)", () => {
  beforeEach(() => {
  ...
  it("Tidak boleh submit dengan field Keperluan Surat Keterangan Kerja kosong", () => {
    ...
    // Keperluan Surat Keterangan Kerja DIKOSONGKAN (tidak diisi)
    ...
    cy.log("✅ Validasi berhasil: Submit gagal karena field Keperluan kosong");
  });
});
