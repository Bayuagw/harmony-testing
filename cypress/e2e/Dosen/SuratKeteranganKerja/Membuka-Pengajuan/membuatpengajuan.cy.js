...
describe("Membuat Pengajuan Surat Keterangan Kerja", () => {
  beforeEach(() => {
  ...
  it("Harus berhasil membuat pengajuan surat keterangan kerja", () => {
    ...
    // Gunakan type untuk mengisi tanggal langsung (format: YYYY-MM-DD)
