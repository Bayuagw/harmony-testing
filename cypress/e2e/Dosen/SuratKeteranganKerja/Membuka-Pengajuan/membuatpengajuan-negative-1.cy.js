...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (Tanggal Selesai Kosong)", () => {
  beforeEach(() => {
  ...
  it("Tidak boleh submit dengan field Tanggal Selesai Kerja kosong", () => {
    ...
    cy.get('input[name="tgl_mulai"]').type("2025-11-01", { force: true });
    cy.log("✅ Tanggal Mulai Kerja terisi");

    // Tanggal Selesai Kerja TIDAK DIISI (dikosongkan)
    ...
    // Isi Keperluan Surat Keterangan Kerja
    ...
    cy.contains("Keperluan Surat Keterangan Kerja")
      .parent()
      .find("input")
      .should("have.value", "Pemberkasan");
    cy.log("✅ Keperluan Surat Keterangan Kerja terisi");
    ...
    cy.log(
      "✅ Validasi berhasil: Submit gagal karena Tanggal Selesai Kerja kosong"
    );
  });
});
