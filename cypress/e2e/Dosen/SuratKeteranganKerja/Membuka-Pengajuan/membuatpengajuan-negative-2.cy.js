...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (Tanggal Mulai Kosong)", () => {
  beforeEach(() => {
  ...
  it("Tidak boleh submit dengan field Tanggal Mulai Kerja kosong", () => {
    ...
    // Tanggal Mulai Kerja TIDAK DIISI (dikosongkan)
    ...
    // Isi Tanggal Selesai Kerja
    cy.get('input[name="tgl_selesai"]').type("2025-11-15", { force: true });
    ...
    cy.log(
      "✅ Validasi berhasil: Submit gagal karena Tanggal Mulai Kerja kosong"
    );
  });
});
