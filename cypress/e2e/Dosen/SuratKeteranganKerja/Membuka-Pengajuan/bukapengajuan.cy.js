...
describe("Buka Pengajuan Surat Keterangan Kerja", () => {
  beforeEach(() => {
    // Login terlebih dahulu sebelum membuka pengajuan
    loginDosen("andika.setiawan@if.itera.ac.id", "SS04ndika");
  });

  it("Membuka halaman Pengajuan Surat Keterangan Kerja", () => {
    ...
    cy.contains("Pengajuan Surat Keterangan Kerja").should("be.visible");
    ...
    cy.log("✅ Berhasil membuka halaman Pengajuan Surat Keterangan Kerja!");
  });
});
