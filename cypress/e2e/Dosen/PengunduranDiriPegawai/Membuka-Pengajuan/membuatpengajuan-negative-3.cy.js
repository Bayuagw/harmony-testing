...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (File Surat Pengunduran Diri Bermaterai berupa PDF >2MB)", () => {
    beforeEach(() => {
    ...
    it("Gagal submit ketika file Surat Pengunduran Diri Bermaterai berupa PDF >2MB", () => {
        // Halaman form tampil
        ...
        cy.contains("Surat Pengunduran Diri Bermaterai")
            ...
            .attachFile("PengunduranDiriPegawai/surat-besar.pdf");

        cy.log("⚠️ File PDF (>2MB) diupload");
        ...
        cy.log("❌ Submit gagal karena file lebih dari 2MB");
    });
});
