...
describe("Buka Pengajuan Pengunduran Diri Pegawai", () => {
    beforeEach(() => {
        // Login terlebih dahulu sebelum membuka pengajuan
        loginDosen("andika.setiawan@if.itera.ac.id", "SS04ndika");
    });

    it("Membuka halaman Pengajuan Pengunduran Diri Pegawai", () => {
        ...
        cy.log("✅ Berhasil membuka halaman Layanan Pengurusan Pengunduran Diri Pegawai!");
    });
});
