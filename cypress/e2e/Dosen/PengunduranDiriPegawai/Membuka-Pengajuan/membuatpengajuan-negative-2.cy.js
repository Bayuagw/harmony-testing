...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (File Surat Pengunduran Diri Bermaterai berupa PPTX)", () => {
    beforeEach(() => {
    ...
    it("Gagal submit ketika file Surat Pengunduran Diri Bermaterai berupa PPTX", () => {
        // Halaman form tampil
        ...
        cy.contains("Surat Pengunduran Diri Bermaterai")
            ...
            .attachFile("PengunduranDiriPegawai/surat-bermaterai.pptx");

        cy.log("⚠️ File PPT diupload");
        ...
        cy.log("❌ Submit gagal karena format PPT tidak valid");
    });
});
