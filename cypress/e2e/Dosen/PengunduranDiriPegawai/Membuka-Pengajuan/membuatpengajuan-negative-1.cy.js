...
describe("Membuat Pengajuan Pengunduran Diri Pegawai - Negative Test (File Surat Pengunduran Diri Bermaterai berupa DOCS)", () => {
    beforeEach(() => {
    ...
    it("Gagal submit ketika file Surat Pengunduran Diri Bermaterai berupa DOCS", () => {
        // Halaman form tampil
        ...
        cy.contains("Surat Pengunduran Diri Bermaterai")
            ...
            .attachFile("PengunduranDiriPegawai/surat-bermaterai.docx");

        cy.log("⚠️ File DOCX diupload");
        ...
        cy.contains("Surat Pengunduran Diri Bermaterai")
            ...
            .then(input => {
                ...
                expect(input[0].files[0].name).to.eq("surat-bermaterai.docx");
            });
        ...
        cy.log("❌ Submit gagal karena format DOCX tidak valid");
    });
});
