...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (Tanggal Mulai Kosong)", () => {
  ...
  it("Tidak boleh submit dengan field Tanggal Mulai kosong", () => {
    ...
    cy.log("✅ Tanggal Selesai SK terisi");
    ...
    cy.contains("Lampiran Anggota")
      ...
      .find("input")
      .clear()
      .type("https://docs.google.com/spreadsheets/d/14kspLzuj4oCtTgz8MqYy7tlgKkiD2xfmCSF8R4OjH0o/edit?gid=0#gid=0");

    // Verifikasi lampiran anggota terisi
    cy.contains("Lampiran Anggota")
      .parent()
      .find("input")
      .should("have.value", "https://docs.google.com/spreadsheets/d/14kspLzuj4oCtTgz8MqYy7tlgKkiD2xfmCSF8R4OjH0o/edit?gid=0#gid=0");
    cy.log("✅ Lampiran Anggota terisi");
