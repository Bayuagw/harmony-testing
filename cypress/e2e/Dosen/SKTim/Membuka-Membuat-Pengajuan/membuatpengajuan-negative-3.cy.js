...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (Keperluan SK Kosong)", () => {
  beforeEach(() => {
  ...
  it("Tidak boleh submit dengan field Keperluan SK Kosong", () => {
    ...
    cy.contains("Keperluan SK Tim")
      ...
      .find("input")
      .should("have.value", " ");
    cy.log("✅ Keperluan SK Tim kosong");
