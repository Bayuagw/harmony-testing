...
describe("Buka Pengajuan SK Tim", () => {
  ...
  it("Membuka halaman Pengajuan SK Tim", () => {
    ...
    cy.contains("Pengajuan Pembuatan SK Tim").should("be.visible");
    ...
    cy.log("✅ Berhasil membuka halaman Pengajuan SK Tim!");
  });
});
