...
describe("Membuat Pengajuan Surat Keterangan Kerja - Negative Test (Semua Field Kosong)", () => {
  ...
  it("Tidak boleh submit dengan field Semua Field Kosong", () => {
    ...
    cy.log("⚠️ Tanggal Mulai SK dikosongkan");

    // Tanggal Selesai SK TIDAK DIISI (dikosongkan)
    cy.get('input[name="tgl_selesai"]').clear({ force: true });
    cy.log("⚠️ Tanggal Selesai SK dikosongkan");

    // Lampiran Anggota TIDAK DIISI (dikosongkan)
    cy.contains("Lampiran Anggota")
      .parent()
      .find("input")
      .clear();

    // Verifikasi Lampiran Anggota TIDAK DIISI (dikosongkan)
    cy.contains("Lampiran Anggota")
      .parent()
      .find("input")
      .should("have.value", "");
    cy.log("⚠️ Lampiran Anggota dikosongkan");

    // Keperluan SK Tim TIDAK DIISI (dikosongkan)
    ...
    cy.contains("Keperluan SK Tim")
      ...
      .find("input")
      .should("have.value", "");
    cy.log("⚠️ Keperluan SK Tim dikosongkan");
